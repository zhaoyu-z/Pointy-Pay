    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      <div className="w-full max-w-sm animate-slide-up">
        ...
        >
          ...
          <p className="text-xs text-text-muted mb-5">Access your payout dashboard</p>
        ...
        <p className="text-center text-sm text-text-muted mt-5">
          ...
          <Link href="/auth/sign-up" className="text-primary hover:text-emerald-400 transition-colors font-medium">
            Sign up
          </Link>
        </p>
